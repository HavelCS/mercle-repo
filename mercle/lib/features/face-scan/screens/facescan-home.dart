...
class _FaceScanSetupState extends State<FaceScanSetup> {
          ...
          (context) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                Text('User ID: ${result['uid'] ?? 'Unknown'}'),
              ],
            ),
            actions: [
              TextButton(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.only(left: 34.w, right: 34.w, top: 75.h),
        child: Column(
...
class _VerificationBottomSheetContent extends StatefulWidget {
  ...
  final Function(bool success, Map<String, dynamic> result) onVerificationComplete;
